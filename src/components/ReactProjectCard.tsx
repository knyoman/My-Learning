...
import { ReactProject } from '../data/reactProjects';
...
interface ReactProjectCardProps {
  ...
  onEdit: (project: ReactProject) => void;
  onToggleComplete: (projectId: number) => void;
}

export const ReactProjectCard: React.FC<ReactProjectCardProps> = ({ project, onEdit, onToggleComplete }) => {
  const [completedTasks, setCompletedTasks] = useLocalStorage<number[]>('reactCompletedTasks', []);
  const [projectNotes, setProjectNotes] = useLocalStorage<{ [key: number]: string }>('reactProjectNotes', {});
  const [projectLinks, setProjectLinks] = useLocalStorage<{ [key: number]: string }>('reactProjectLinks', {});
  const [githubLinks, setGithubLinks] = useLocalStorage<{ [key: number]: string }>('reactGithubLinks', {});
  ...
  return (
    ...
    `}>
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-cyan-600/5 via-blue-600/5 to-indigo-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      ...
      <div className="relative p-6 z-10">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3 flex-1">
            <div className={`
              ...
              ${isCompleted ? 'bg-green-500 text-white' : 'bg-cyan-500 text-white'}
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                {!isEditing ? (
                  ...
                  <select
                    ...
                    className="px-2 py-1 rounded-full text-xs bg-gray-800 text-white border border-cyan-500/30"
                  >
              ...
              {!isEditing ? (
                ...
                <input
                  ...
                  className="w-full bg-gray-800/50 border border-cyan-500/30 rounded-lg px-3 py-1 text-white text-sm"
                />
              )}
            </div>
          </div>
            ...
            <button
              ...
              className={`
                ...
                ${isCompleted 
                  ...
                  : 'bg-cyan-500/20 hover:bg-cyan-500 text-cyan-300 hover:text-white'
                }
              `}
            >
              <Check size={16} />
        ...
        {!isEditing ? (
          ...
          <textarea
            ...
            className="w-full bg-gray-800/50 border border-cyan-500/30 rounded-lg p-3 text-white text-sm resize-none h-20 mb-4"
          />
        )}
        ...
        {isEditing && (
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full bg-gray-800/50 border border-cyan-500/30 rounded-lg p-3 text-white placeholder-gray-400 text-sm focus:outline-none focus:border-cyan-400 transition-colors"
            />
          </div>
        )}
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-cyan-500/30">
              <textarea
                ...
                className="w-full h-20 bg-transparent border border-cyan-500/30 rounded-lg p-3 text-white placeholder-gray-400 text-sm resize-none focus:outline-none focus:border-cyan-400 transition-colors"
              />
            </div>
          </div>
        )}
